---
title: "Using the ESCTreeModel API v0.5"
# subtitle: "v0.5"
execute: 
  enabled: true
...
baseline_ESCDoseVals = ESCTreeModelresponse_dict.get("UKCP09").get("Baseline").get("ESCDoseVals")
...
```{r ESCDoseVals_r}
baseline_ESCDoseVals = ESCTreeModelresponse_list$UKCP09$Baseline$ESCDoseVals
baseline_ESCDoseVals
```
...
baseline_ESCResponseVals = ESCTreeModelresponse_dict.get("UKCP09").get("Baseline").get("ESCResponseVals")
...
```{r ESCResponseVals_r}
baseline_ESCResponseVals = ESCTreeModelresponse_list$UKCP09$Baseline$ESCResponseVals
baseline_ESCResponseVals |> head()
```
...
baseline_ESCSuitMetrics = ESCTreeModelresponse_dict.get("UKCP09").get("Baseline").get("ESCSuitMetrics")
...
```{r ESCSuitMetrics_r}
baseline_ESCSuitMetrics = ESCTreeModelresponse_list$UKCP09$Baseline$ESCSuitMetrics
baseline_ESCSuitMetrics |> head()
```
