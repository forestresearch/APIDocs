...
baseline_ESCDoseVals = ESCTreeResultsresponse_dict.get("RCP2.6").get("Baseline").get("ESCDoseVals")
...
```{r ESCDoseVals_r}
baseline_ESCDoseVals = ESCTreeResultsresponse_list$RCP2.6$Baseline$ESCDoseVals
baseline_ESCDoseVals
```
...
baseline_ESCResponseVals = ESCTreeResultsresponse_dict.get("RCP2.6").get("Baseline").get("ESCResponseVals")
...
```{r ESCResponseVals_r}
baseline_ESCResponseVals = ESCTreeResultsresponse_list$RCP2.6$Baseline$ESCResponseVals
baseline_ESCResponseVals |> head()
```
...
baseline_ESCSuitMetrics = ESCTreeResultsresponse_dict.get("RCP2.6").get("Baseline").get("ESCSuitMetrics")
...
```{r ESCSuitMetrics_r}
baseline_ESCSuitMetrics = ESCTreeResultsresponse_list$RCP2.6$Baseline$ESCSuitMetrics
baseline_ESCSuitMetrics |> head()
```
