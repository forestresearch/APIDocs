...
```{python spman_py}
baseline_WCCTreeValues_selSpp_1p5_Thinned = baseline_WCCTreeValues_selSpp[(baseline_WCCTreeValues_selSpp.spacing == 1.5) & (baseline_WCCTreeValues_selSpp.management == "Thinned")]
baseline_WCCTreeValues_selSpp_1p5_Thinned.head()
```

## R

```{r spman_r}
baseline_WCCTreeValues_selSpp_1p5_Thinned <- baseline_WCCTreeValues_selSpp |>
...
```{python setDF_py}
df = baseline_WCCTreeValues_selSpp_1p5_Thinned
